            ...
            <div className='container'>
                <div className='cat-single-content'>
                    <div className='section-title'>
                        <h3 className='text-uppercase fw-7 text-regal-blue ls-1'>{products.name}</h3>
                    </div>
                            ...
                            products.map(product => (
                                <div className='product-item bg-white' key = {product.id} onClick = {() => viewModalHandler(product)}>
                                    <div className='product-item-img'>
                                        ...
                                        <div className = "product-item-cat text-white fs-13 text-uppercase bg-gold fw-6">{product.name}</div>
                                    </div>
